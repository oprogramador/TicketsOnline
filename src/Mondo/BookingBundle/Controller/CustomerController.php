...
class CustomerController extends Controller implements ITranslateable 
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MondoBookingBundle:Customer')->findAll();

        return $this->render('MondoBookingBundle:Customer:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MondoBookingBundle:Customer')->find($id);
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MondoBookingBundle:Customer:edit.html.twig', array(
            'entity'      => $entity,
